        ...
        <div className="flex flex-col md:flex-row md:px-20 items-center justify-center mt-10">
          ...
          >
            <div className="text-center md:text-left">
              ...
              kebersamaan, kami, Wirabhakti, berupaya menciptakan lingkungan
        ...
        <div className="flex flex-col md:flex-row md:px-20 items-center justify-center mt-10">
          ...
          >
            <div className="text-start md:text-left">
              ...
              <div className="mb-2">
                Desa Kliran X terletak di kawasan Sendangagung, Kecamatan
                Minggir, Kabupaten Sleman, Yogyakarta. Desa ini menawarkan
                suasana pedesaan yang tenang dan asri, dengan pemandangan alam
                yang indah serta udara yang sejuk. Terkenal dengan keakraban dan
                gotong royong warganya, Kliran X merupakan contoh nyata dari
                kehidupan masyarakat desa yang harmonis dan penuh kebersamaan.
              </div>
              <br />
              <div className="mb-2">
                ...
                Warga Kliran X sebagian besar bermata pencaharian sebagai
                petani, yang masih menggunakan metode pertanian tradisional yang
                ramah lingkungan.
              </div>
              <br />
              Selain keindahan alam, Kliran X juga memiliki beberapa fasilitas
              umum yang mendukung kehidupan warganya, tempat ibadah, dan
              lapangan olahraga. Desa ini juga aktif dalam berbagai kegiatan
              sosial dan budaya, seperti acara gotong royong, perayaan hari
              besar keagamaan, dan kegiatan Karang Taruna Wira Bakti, yang
              menjadi wadah bagi generasi muda untuk berkumpul, belajar, dan
              berkontribusi bagi pembangunan desa.
            </div>
          </motion.div>
        </div>
      </div>
